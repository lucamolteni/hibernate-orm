...
public final class Constants {
	...
	public static final String QUARKUS_DATA_ENTITY_MARKER = "io.quarkus.data.jpa.QuarkusDataEntityMarker";
	public static final String QUARKUS_DATA_MANAGED_BLOCKING_REPOSITORY_BASE = "io.quarkus.data.jpa.managed.blocking.ManagedBlockingRepositoryBase";
	public static final String QUARKUS_DATA_STATELESS_BLOCKING_REPOSITORY_BASE = "io.quarkus.data.jpa.stateless.blocking.DataBlockingRepositoryBase";
	public static final String QUARKUS_DATA_MANAGED_REACTIVE_REPOSITORY_BASE = "io.quarkus.data.jpa.managed.reactive.ManagedReactiveRepositoryBase";
	public static final String QUARKUS_DATA_STATELESS_REACTIVE_REPOSITORY_BASE = "io.quarkus.data.jpa.stateless.reactive.DataReactiveRepositoryBase";
