...
@JiraKey(value = "HHH-18311")
@DomainModel(
		annotatedClasses = {
				InsertionStrategyTest.TestEntity.class,
				InsertionStrategyTest.TestEntityType1.class,
				InsertionStrategyTest.TestEntityType2.class
		}
)
@SessionFactory(
...
@ServiceRegistry(
		settingProviders = @SettingProvider(
				...
				provider = InsertionStrategyTest.TableMutationStrategyProvider.class
		)
)
public class InsertionStrategyTest {
	...
	public static class TableMutationStrategyProvider implements SettingProvider.Provider<String> {
		...
		public String getSetting() {
			return CteInsertStrategy.class.getName();
		}
	}
