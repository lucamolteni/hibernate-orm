...
public class HbmXmlComponentVisitorTest {
	...
	/**
	 * Simulates how Quarkus would use the handler at build time:
	 * empty embeddableInfoByRole (no boot model), a mapping root to collect embeddables,
	 * and no nested attribute processor.
	 */
